...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a class="logo d-flex align-items-center">
            <img src="{{ asset('/img/tooth.png')}}" alt="">
    ...
    <div class="search-bar">
        <form class="search-form d-flex align-items-center" id="search_form">
            @csrf
            <input type="text" id="keyword" name="keyword" placeholder="Search Keyword..." title="Enter search keyword">
